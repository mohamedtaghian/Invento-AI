...
import { metaWith } from '../stepper-shared/meta/meta.util';
import { BlockViewer } from '../stepper-shared/blocks/block-viewer';
import { hlmCode } from '../ui/typography/src/lib/hlm-code';
...
@Component({
  ...
  template: `
    ...
    <spartan-block-viewer
      block="stepper-linear"
      title="A linear stepper with validation"
      id="stepper-4"
    >
      <p class="text-muted-foreground max-w-3xl text-sm text-pretty">
        With
    ...
    <spartan-block-viewer
      block="stepper-lazy-content"
      title="A stepper with lazy content"
      id="stepper-5"
    >
      <p class="text-muted-foreground max-w-3xl text-sm text-pretty">
        Use
    ...
    <spartan-block-viewer
      ...
      title="A stepper with layout controls"
      id="stepper-6"
    >
      <p class="text-muted-foreground max-w-3xl text-sm text-pretty">
    ...
    <spartan-block-viewer
      block="stepper-animations"
      title="A stepper with animation controls"
      id="stepper-7"
    >
      <p class="text-muted-foreground max-w-3xl text-sm text-pretty">
    ...
    <spartan-block-viewer
      block="stepper-indicators"
      title="A stepper with indicator modes"
      id="stepper-8"
    >
      <p class="text-muted-foreground max-w-3xl text-sm text-pretty">

...
import { ProductService, ApiProductDetail } from '@invento/invento-data-access-product';
import { SupplierService, Supplier } from '@invento/invento-data-access-supplier';
import {
  MailboxStatus,
  ...
  SupplierOffer,
} from '@invento/invento-data-access-purchase-request';

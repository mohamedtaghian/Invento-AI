...
import {
  ...
  HeroSectionResponse,
  StoreResponse,
} from '@invento/invento-data-access-store';
import { CategoriesService } from '@invento/invento-data-access-category';
import { ProductService } from '@invento/invento-data-access-product';

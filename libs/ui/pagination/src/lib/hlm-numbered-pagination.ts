			...
			<nav hlmPagination>
				<ul hlmPaginationContent>
					@if (showEdges() && !_isFirstPageActive()) {
						<li hlmPaginationItem (click)="goToPrevious()" (keydown.enter)="goToPrevious()" tabindex="0">
					...
					@for (page of _pages(); track page) {
						<li hlmPaginationItem>
							@if (page === '...') {
								...
								<a hlmPaginationLink [isActive]="currentPage() === page" (click)="currentPage.set(page)" (keydown.enter)="currentPage.set(page)" tabindex="0">
									{{ page }}
								</a>
							}
						</li>
					...
					@if (showEdges() && !_isLastPageActive()) {
						<li hlmPaginationItem (click)="goToNext()" (keydown.enter)="goToNext()" tabindex="0">
							<hlm-pagination-next />
						</li>
					}
				</ul>

...
const BUSINESS_MODELS: readonly Rule[] = [
  ...
  {
    value: 'Physical',
    pattern: /\b(physical|equipment|bands|products|clothing|goods|hardware)\b/i,
  },
];
...
const CATEGORIES: readonly CategoryRule[] = [
  ...
  },
  {
    ...
    pattern:
      /\b(tech|technology|software|apps?|artificial intelligence|digital|code|cloud|saas)\b/i,
  },
  {
    value: 'Food & Beverage',

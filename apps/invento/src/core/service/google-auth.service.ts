...
export class GoogleAuthService {
  ...
  getClientId(): string {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (injected?.['GOOGLE_CLIENT_ID']) return injected['GOOGLE_CLIENT_ID'];
      if (typeof w['GOOGLE_CLIENT_ID'] === 'string' && w['GOOGLE_CLIENT_ID']) {
        return w['GOOGLE_CLIENT_ID'] as string;
      }
    }
    return '';
  }

...
import { lucideLayoutDashboard, lucidePackage, lucideUsers, lucideShoppingCart, lucideTruck, lucideBarChart3, lucideBot } from '@ng-icons/lucide';
...
@Component({
  ...
  providers: [
    provideIcons({ lucideLayoutDashboard, lucidePackage, lucideUsers, lucideShoppingCart, lucideTruck, lucideBarChart3, lucideBot }),
  ],
